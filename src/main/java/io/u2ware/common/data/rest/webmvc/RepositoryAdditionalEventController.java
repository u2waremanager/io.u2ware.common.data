package io.u2ware.common.data.rest.webmvc;
...
public abstract class RepositoryAdditionalEventController extends CopiedAbstractRepositoryRestController {
    ...
    public ResponseEntity<EntityModel<?>> getItemResource(RootResourceInformation resourceInformation,
        ...
        Optional<Object> resource = executeFindBySerializable(repository, id);
    ...
    public <T> CollectionModel<?> getCollectionResource(@QuerydslPredicate RootResourceInformation resourceInformation,
        ...
        Iterable<?> results = executeFindByPartTree(repository, content, unpaged, pageable.getPageable(), sort, partTree);
    ...
    protected abstract Optional<Object> executeFindBySerializable(Repository<?,?> repository, Serializable content);

    protected abstract Iterable<?> executeFindByPartTree(Repository<?,?> repository, Object content, boolean unpaged, Pageable pageable, Sort sort, String partTree);

    protected abstract void verifySupportedMethod(Repository<?,?> repository);
