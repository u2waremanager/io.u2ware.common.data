...
public class JpaSpecificationBuilder<T> {
    ...
    public WhereBuilder<T> where(boolean distinct) {
        specification.and(((r,q,b)->{
            q.distinct(distinct); 
            return null;
        }));
        return new WhereBuilder<>(specification, this);
    ...
    public static class OrderBuilder<T> {
        ...
        private Specification<T> build(Sort sort) {
        ...
        public OrderBuilder<T> asc(String property) {
            specification.and(build(Sort.by(Direction.ASC, property)));
            return this;
        }
        public OrderBuilder<T> desc(String property){
            specification.and(build(Sort.by(Direction.DESC, property)));
            return this;
        }
    }
    ...
    public abstract static class OperationBuilder<T, P> {
        ...
        private P criteria(String source, Object value) {
            if(value == null || "".equals(value)) return parent;
            return criteria( new PartTreeSpecification<>(source, Collections.singletonList(value)));
        }
        ...
        public P like(String property, Object value){
            return criteria(property+"Like", value);
        }
        public P notLike(String property, Object value){
            return criteria(property+"NotLike", value);
        }
        public P containing(String property, Object value){
            return criteria(property+"ContainingIgnoreCase", value);
        }
        public P notContaining(String property, Object value){return criteria(property+"NotContainingIgnoreCase", value);}
